...
骄傲,jiāo’ào,proud
伤心,shāngxīn,sad
受不了,shòubuliǎo,cannot stand
同情,tóngqíng,sympathize
羡慕,xiànmù,envy
零钱,língqián,change
无聊,wúliáo,boring
迷路,mílù,get lost
...
怀疑,huáiyí,doubt
积极,jījí,positive
可怜,kělián,poor/pitiful
可惜,kěxī,unfortunate
讨厌,tǎoyàn,dislike
打折,dǎzhé,discount
工资,gōngzī,salary
关键,guānjiàn,key point
规定,guīdìng,rule
力气,lìqi,strength
内容,nèiróng,content
...
function nextCard() {
  ...
  const index = Math.floor(Math.random() * unknownPool.length);
  current = unknownPool[index];
  showingBack = false;
...
function updateStats() {
  ...
  document.getElementById("unseen").innerText =
    sessionWords.length - seenSet.size;
}
